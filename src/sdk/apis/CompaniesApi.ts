...
export interface CompaniesApiGetAllCompaniesRequest {
    page?: number;
}
...
export class CompaniesApi extends runtime.BaseAPI {
     ...
     */
    async getAllCompaniesRaw(requestParameters: CompaniesApiGetAllCompaniesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllCompanies200Response>> {
     ...
     * returns a paginated list of company records
     */
    async getAllCompanies(requestParameters: CompaniesApiGetAllCompaniesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllCompanies200Response> {
     ...
     */
    async getCompanyRaw(requestParameters: CompaniesApiGetCompanyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCompany200Response>> {
     ...
     * returns a company record
     */
    async getCompany(requestParameters: CompaniesApiGetCompanyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCompany200Response> {
