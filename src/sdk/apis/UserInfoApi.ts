...
export interface UserInfoApiGetUserInfoByIdRequest {
    id: number;
}
...
export class UserInfoApi extends runtime.BaseAPI {
     ...
     */
    async getUserInfoByIdRaw(requestParameters: UserInfoApiGetUserInfoByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserInfo200Response>> {
     ...
     * returns user info by user id
     */
    async getUserInfoById(requestParameters: UserInfoApiGetUserInfoByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUserInfo200Response> {
