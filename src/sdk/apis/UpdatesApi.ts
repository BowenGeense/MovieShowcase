...
export interface UpdatesApiUpdatesRequest {
    since: number;
...
export class UpdatesApi extends runtime.BaseAPI {
     ...
     */
    async updatesRaw(requestParameters: UpdatesApiUpdatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Updates200Response>> {
     ...
     * Returns updated entities.  methodInt indicates a created record (1), an updated record (2), or a deleted record (3).  If a record is deleted because it was a duplicate of another record, the target record\'s information is provided in mergeToType and mergeToId.
     */
    async updates(requestParameters: UpdatesApiUpdatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Updates200Response> {
