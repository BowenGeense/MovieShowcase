...
export interface PeopleApiGetAllPeopleRequest {
    page?: number;
}

export interface PeopleApiGetPeopleBaseRequest {
    id: number;
}

export interface PeopleApiGetPeopleExtendedRequest {
    id: number;
    meta?: GetPeopleExtendedMetaEnum;
}

export interface PeopleApiGetPeopleTranslationRequest {
    id: number;
    language: string;
}
...
export class PeopleApi extends runtime.BaseAPI {
     ...
     */
    async getAllPeopleRaw(requestParameters: PeopleApiGetAllPeopleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllPeople200Response>> {
     ...
     * Returns a list of people base records with the basic attributes.
     */
    async getAllPeople(requestParameters: PeopleApiGetAllPeopleRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllPeople200Response> {
     ...
     */
    async getPeopleBaseRaw(requestParameters: PeopleApiGetPeopleBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetPeopleBase200Response>> {
     ...
     * Returns people base record
     */
    async getPeopleBase(requestParameters: PeopleApiGetPeopleBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetPeopleBase200Response> {
     ...
     */
    async getPeopleExtendedRaw(requestParameters: PeopleApiGetPeopleExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetPeopleExtended200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns people extended record
     */
    async getPeopleExtended(requestParameters: PeopleApiGetPeopleExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetPeopleExtended200Response> {
     ...
     */
    async getPeopleTranslationRaw(requestParameters: PeopleApiGetPeopleTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeTranslation200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns people translation record
     */
    async getPeopleTranslation(requestParameters: PeopleApiGetPeopleTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeTranslation200Response> {
