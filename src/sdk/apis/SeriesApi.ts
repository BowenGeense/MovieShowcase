...
export interface SeriesApiGetAllSeriesRequest {
    page?: number;
}

export interface SeriesApiGetSeriesArtworksRequest {
    id: number;
    lang?: string;
    type?: number;
}

export interface SeriesApiGetSeriesBaseRequest {
    id: number;
}

export interface SeriesApiGetSeriesBaseBySlugRequest {
    slug: string;
}

export interface SeriesApiGetSeriesEpisodesRequest {
    page: number;
    id: number;
    seasonType: string;
    season?: number;
...
export interface SeriesApiGetSeriesExtendedRequest {
    id: number;
    meta?: GetSeriesExtendedMetaEnum;
    _short?: boolean;
}

export interface SeriesApiGetSeriesFilterRequest {
    country: string;
    lang: string;
    company?: number;
...
export interface SeriesApiGetSeriesNextAiredRequest {
    id: number;
}

export interface SeriesApiGetSeriesSeasonEpisodesTranslatedRequest {
    page: number;
    id: number;
    seasonType: string;
    lang: string;
...
export interface SeriesApiGetSeriesTranslationRequest {
    id: number;
    language: string;
}
...
export class SeriesApi extends runtime.BaseAPI {
     ...
     */
    async getAllSeriesRaw(requestParameters: SeriesApiGetAllSeriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllSeries200Response>> {
     ...
     * returns list of series base records
     */
    async getAllSeries(requestParameters: SeriesApiGetAllSeriesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllSeries200Response> {
     ...
     */
    async getSeriesArtworksRaw(requestParameters: SeriesApiGetSeriesArtworksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesArtworks200Response>> {
     ...
     * Returns series artworks base on language and type. <br> Note&#58; Artwork type is an id that can be found using **_/artwork/types** endpoint.
     */
    async getSeriesArtworks(requestParameters: SeriesApiGetSeriesArtworksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesArtworks200Response> {
     ...
     */
    async getSeriesBaseRaw(requestParameters: SeriesApiGetSeriesBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesBase200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns series base record
     */
    async getSeriesBase(requestParameters: SeriesApiGetSeriesBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesBase200Response> {
     ...
     */
    async getSeriesBaseBySlugRaw(requestParameters: SeriesApiGetSeriesBaseBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesBase200Response>> {
     ...
     * Returns series base record searched by slug
     */
    async getSeriesBaseBySlug(requestParameters: SeriesApiGetSeriesBaseBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesBase200Response> {
     ...
     */
    async getSeriesEpisodesRaw(requestParameters: SeriesApiGetSeriesEpisodesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesEpisodes200Response>> {
        if (requestParameters['page'] == null) {
            throw new runtime.RequiredError(
                'page',
     ...
     * Returns series episodes from the specified season type, default returns the episodes in the series default season type
     */
    async getSeriesEpisodes(requestParameters: SeriesApiGetSeriesEpisodesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesEpisodes200Response> {
     ...
     */
    async getSeriesExtendedRaw(requestParameters: SeriesApiGetSeriesExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesArtworks200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns series extended record
     */
    async getSeriesExtended(requestParameters: SeriesApiGetSeriesExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesArtworks200Response> {
     ...
     */
    async getSeriesFilterRaw(requestParameters: SeriesApiGetSeriesFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesFilter200Response>> {
     ...
     * Search series based on filter parameters
     */
    async getSeriesFilter(requestParameters: SeriesApiGetSeriesFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesFilter200Response> {
     ...
     */
    async getSeriesNextAiredRaw(requestParameters: SeriesApiGetSeriesNextAiredRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesBase200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns series base record including the nextAired field. <br> Note&#58; nextAired was included in the base record endpoint but that field will deprecated in the future so developers should use the nextAired endpoint.
     */
    async getSeriesNextAired(requestParameters: SeriesApiGetSeriesNextAiredRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesBase200Response> {
     ...
     */
    async getSeriesSeasonEpisodesTranslatedRaw(requestParameters: SeriesApiGetSeriesSeasonEpisodesTranslatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeriesSeasonEpisodesTranslated200Response>> {
        if (requestParameters['page'] == null) {
            throw new runtime.RequiredError(
                'page',
     ...
     * Returns series base record with episodes from the specified season type and language. Default returns the episodes in the series default season type.
     */
    async getSeriesSeasonEpisodesTranslated(requestParameters: SeriesApiGetSeriesSeasonEpisodesTranslatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeriesSeasonEpisodesTranslated200Response> {
     ...
     */
    async getSeriesTranslationRaw(requestParameters: SeriesApiGetSeriesTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeTranslation200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns series translation record
     */
    async getSeriesTranslation(requestParameters: SeriesApiGetSeriesTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeTranslation200Response> {
