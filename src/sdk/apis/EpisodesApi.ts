...
export interface EpisodesApiGetAllEpisodesRequest {
    page?: number;
}

export interface EpisodesApiGetEpisodeBaseRequest {
    id: number;
}

export interface EpisodesApiGetEpisodeExtendedRequest {
    id: number;
    meta?: GetEpisodeExtendedMetaEnum;
}

export interface EpisodesApiGetEpisodeTranslationRequest {
    id: number;
    language: string;
}
...
export class EpisodesApi extends runtime.BaseAPI {
     ...
     */
    async getAllEpisodesRaw(requestParameters: EpisodesApiGetAllEpisodesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllEpisodes200Response>> {
     ...
     * Returns a list of episodes base records with the basic attributes.<br> Note that all episodes are returned, even those that may not be included in a series\' default season order.
     */
    async getAllEpisodes(requestParameters: EpisodesApiGetAllEpisodesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllEpisodes200Response> {
     ...
     */
    async getEpisodeBaseRaw(requestParameters: EpisodesApiGetEpisodeBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeBase200Response>> {
     ...
     * Returns episode base record
     */
    async getEpisodeBase(requestParameters: EpisodesApiGetEpisodeBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeBase200Response> {
     ...
     */
    async getEpisodeExtendedRaw(requestParameters: EpisodesApiGetEpisodeExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeExtended200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns episode extended record
     */
    async getEpisodeExtended(requestParameters: EpisodesApiGetEpisodeExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeExtended200Response> {
     ...
     */
    async getEpisodeTranslationRaw(requestParameters: EpisodesApiGetEpisodeTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeTranslation200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns episode translation record
     */
    async getEpisodeTranslation(requestParameters: EpisodesApiGetEpisodeTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeTranslation200Response> {
