...
export interface ListsApiGetAllListsRequest {
    page?: number;
}
...
export interface ListsApiGetListBySlugRequest {
    slug: string;
}

export interface ListsApiGetListExtendedRequest {
    id: number;
}

export interface ListsApiGetListTranslationRequest {
    id: number;
    language: string;
}
...
export class ListsApi extends runtime.BaseAPI {
     ...
     */
    async getAllListsRaw(requestParameters: ListsApiGetAllListsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllLists200Response>> {
     ...
     * returns list of list base records
     */
    async getAllLists(requestParameters: ListsApiGetAllListsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllLists200Response> {
     ...
     */
    async getListRaw(requestParameters: ListsApiGetListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetList200Response>> {
     ...
     * returns an list base record
     */
    async getList(requestParameters: ListsApiGetListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetList200Response> {
     ...
     */
    async getListBySlugRaw(requestParameters: ListsApiGetListBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetList200Response>> {
     ...
     * returns an list base record search by slug
     */
    async getListBySlug(requestParameters: ListsApiGetListBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetList200Response> {
     ...
     */
    async getListExtendedRaw(requestParameters: ListsApiGetListExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetListExtended200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * returns a list extended record
     */
    async getListExtended(requestParameters: ListsApiGetListExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetListExtended200Response> {
     ...
     */
    async getListTranslationRaw(requestParameters: ListsApiGetListTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetListTranslation200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns list translation record
     */
    async getListTranslation(requestParameters: ListsApiGetListTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetListTranslation200Response> {
