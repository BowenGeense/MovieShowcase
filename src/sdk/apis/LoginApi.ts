...
export interface LoginApiLoginPostOperationRequest {
...
export class LoginApi extends runtime.BaseAPI {
     ...
     */
    async loginPostRaw(requestParameters: LoginApiLoginPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LoginPost200Response>> {
     ...
     * create an auth token. The token has one month validation length.
     */
    async loginPost(requestParameters: LoginApiLoginPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LoginPost200Response> {
