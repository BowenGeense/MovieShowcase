...
export interface MoviesApiGetAllMovieRequest {
    page?: number;
}

export interface MoviesApiGetMovieBaseRequest {
    id: number;
}

export interface MoviesApiGetMovieBaseBySlugRequest {
    slug: string;
}

export interface MoviesApiGetMovieExtendedRequest {
    id: number;
    meta?: GetMovieExtendedMetaEnum;
    _short?: boolean;
}

export interface MoviesApiGetMovieTranslationRequest {
    id: number;
    language: string;
}

export interface MoviesApiGetMoviesFilterRequest {
    country: string;
    lang: string;
    company?: number;
...
export class MoviesApi extends runtime.BaseAPI {
     ...
     */
    async getAllMovieRaw(requestParameters: MoviesApiGetAllMovieRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllMovie200Response>> {
     ...
     * returns list of movie base records
     */
    async getAllMovie(requestParameters: MoviesApiGetAllMovieRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllMovie200Response> {
     ...
     */
    async getMovieBaseRaw(requestParameters: MoviesApiGetMovieBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMovieBase200Response>> {
     ...
     * Returns movie base record
     */
    async getMovieBase(requestParameters: MoviesApiGetMovieBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMovieBase200Response> {
     ...
     */
    async getMovieBaseBySlugRaw(requestParameters: MoviesApiGetMovieBaseBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMovieBase200Response>> {
     ...
     * Returns movie base record search by slug
     */
    async getMovieBaseBySlug(requestParameters: MoviesApiGetMovieBaseBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMovieBase200Response> {
     ...
     */
    async getMovieExtendedRaw(requestParameters: MoviesApiGetMovieExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMovieExtended200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns movie extended record
     */
    async getMovieExtended(requestParameters: MoviesApiGetMovieExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMovieExtended200Response> {
     ...
     */
    async getMovieTranslationRaw(requestParameters: MoviesApiGetMovieTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeTranslation200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns movie translation record
     */
    async getMovieTranslation(requestParameters: MoviesApiGetMovieTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeTranslation200Response> {
     ...
     */
    async getMoviesFilterRaw(requestParameters: MoviesApiGetMoviesFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMoviesFilter200Response>> {
     ...
     * Search movies based on filter parameters
     */
    async getMoviesFilter(requestParameters: MoviesApiGetMoviesFilterRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMoviesFilter200Response> {
