...
export interface SeasonsApiGetAllSeasonsRequest {
    page?: number;
}

export interface SeasonsApiGetSeasonBaseRequest {
    id: number;
}

export interface SeasonsApiGetSeasonExtendedRequest {
    id: number;
}

export interface SeasonsApiGetSeasonTranslationRequest {
    id: number;
    language: string;
}
...
export class SeasonsApi extends runtime.BaseAPI {
     ...
     */
    async getAllSeasonsRaw(requestParameters: SeasonsApiGetAllSeasonsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllSeasons200Response>> {
     ...
     * returns list of seasons base records
     */
    async getAllSeasons(requestParameters: SeasonsApiGetAllSeasonsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllSeasons200Response> {
     ...
     */
    async getSeasonBaseRaw(requestParameters: SeasonsApiGetSeasonBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeasonBase200Response>> {
     ...
     * Returns season base record
     */
    async getSeasonBase(requestParameters: SeasonsApiGetSeasonBaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeasonBase200Response> {
     ...
     */
    async getSeasonExtendedRaw(requestParameters: SeasonsApiGetSeasonExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSeasonExtended200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns season extended record
     */
    async getSeasonExtended(requestParameters: SeasonsApiGetSeasonExtendedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSeasonExtended200Response> {
     ...
     */
    async getSeasonTranslationRaw(requestParameters: SeasonsApiGetSeasonTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetEpisodeTranslation200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Returns season translation record
     */
    async getSeasonTranslation(requestParameters: SeasonsApiGetSeasonTranslationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetEpisodeTranslation200Response> {
