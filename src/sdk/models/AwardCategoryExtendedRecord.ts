 ...
 */
export function instanceOfAwardCategoryExtendedRecord(value: object): boolean {
    return true;
}
...
export function AwardCategoryExtendedRecordToJSON(value?: AwardCategoryExtendedRecord | null): any {
    if (value == null) {
        return value;
    }
    return {
