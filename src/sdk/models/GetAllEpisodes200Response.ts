 ...
 */
export function instanceOfGetAllEpisodes200Response(value: object): boolean {
    return true;
}
...
export function GetAllEpisodes200ResponseToJSON(value?: GetAllEpisodes200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
