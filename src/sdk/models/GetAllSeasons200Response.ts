 ...
 */
export function instanceOfGetAllSeasons200Response(value: object): boolean {
    return true;
}
...
export function GetAllSeasons200ResponseToJSON(value?: GetAllSeasons200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
