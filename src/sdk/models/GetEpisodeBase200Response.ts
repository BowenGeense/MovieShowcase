 ...
 */
export function instanceOfGetEpisodeBase200Response(value: object): boolean {
    return true;
}
...
export function GetEpisodeBase200ResponseToJSON(value?: GetEpisodeBase200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
