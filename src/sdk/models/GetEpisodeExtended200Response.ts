 ...
 */
export function instanceOfGetEpisodeExtended200Response(value: object): boolean {
    return true;
}
...
export function GetEpisodeExtended200ResponseToJSON(value?: GetEpisodeExtended200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
