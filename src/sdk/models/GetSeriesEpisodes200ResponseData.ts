 ...
 */
export function instanceOfGetSeriesEpisodes200ResponseData(value: object): boolean {
    return true;
}
...
export function GetSeriesEpisodes200ResponseDataToJSON(value?: GetSeriesEpisodes200ResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
