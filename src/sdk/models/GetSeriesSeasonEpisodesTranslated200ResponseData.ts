 ...
 */
export function instanceOfGetSeriesSeasonEpisodesTranslated200ResponseData(value: object): boolean {
    return true;
}
...
export function GetSeriesSeasonEpisodesTranslated200ResponseDataToJSON(value?: GetSeriesSeasonEpisodesTranslated200ResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
