 ...
 */
export function instanceOfGetAllInspirationTypes200Response(value: object): boolean {
    return true;
}
...
export function GetAllInspirationTypes200ResponseToJSON(value?: GetAllInspirationTypes200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
