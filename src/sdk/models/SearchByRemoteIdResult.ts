 ...
 */
export function instanceOfSearchByRemoteIdResult(value: object): boolean {
    return true;
}
...
export function SearchByRemoteIdResultToJSON(value?: SearchByRemoteIdResult | null): any {
    if (value == null) {
        return value;
    }
    return {
