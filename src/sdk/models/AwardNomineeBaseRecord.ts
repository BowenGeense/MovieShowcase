 ...
 */
export function instanceOfAwardNomineeBaseRecord(value: object): boolean {
    return true;
}
...
export function AwardNomineeBaseRecordToJSON(value?: AwardNomineeBaseRecord | null): any {
    if (value == null) {
        return value;
    }
    return {
