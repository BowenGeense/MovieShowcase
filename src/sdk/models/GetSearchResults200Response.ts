 ...
 */
export function instanceOfGetSearchResults200Response(value: object): boolean {
    return true;
}
...
export function GetSearchResults200ResponseToJSON(value?: GetSearchResults200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
