 ...
 */
export function instanceOfAwardCategoryBaseRecord(value: object): boolean {
    return true;
}
...
export function AwardCategoryBaseRecordToJSON(value?: AwardCategoryBaseRecord | null): any {
    if (value == null) {
        return value;
    }
    return {
