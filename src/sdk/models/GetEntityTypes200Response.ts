 ...
 */
export function instanceOfGetEntityTypes200Response(value: object): boolean {
    return true;
}
...
export function GetEntityTypes200ResponseToJSON(value?: GetEntityTypes200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
