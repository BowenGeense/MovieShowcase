 ...
 */
export function instanceOfGetAllContentRatings200Response(value: object): boolean {
    return true;
}
...
export function GetAllContentRatings200ResponseToJSON(value?: GetAllContentRatings200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
